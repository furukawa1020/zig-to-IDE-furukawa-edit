...
const definitions = [_]Definition{
    ...
    .{ .id = "lsp.apply_workspace_edit", .title = "Apply LSP Workspace Edit", .description = "Apply the last LSP WorkspaceEdit to editor buffers after workspace boundary and range checks.", .default_key = "", .scope = .workspace, .capability = .workspace_write },
