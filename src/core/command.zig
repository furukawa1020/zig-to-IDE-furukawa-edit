...
const definitions = [_]Definition{
    ...
    .{ .id = "debug.toggle_breakpoint", .title = "Toggle Breakpoint", .description = "Toggle a source breakpoint on the active editor line.", .default_key = "f9", .scope = .debug, .capability = .safe },
    ...
    .{ .id = "debug.watch_add", .title = "Add Restricted Debug Watch", .description = "Add an inspection-shaped watch expression; calls, assignments, statements, and arithmetic or logical operators are rejected.", .default_key = "", .scope = .debug, .capability = .safe },
    .{ .id = "debug.watch_remove", .title = "Remove Debug Watch", .description = "Remove a watch by its one-based list index.", .default_key = "", .scope = .debug, .capability = .safe },
    .{ .id = "debug.watch_clear", .title = "Clear Debug Watches", .description = "Remove every watch expression kept by the current IDE session.", .default_key = "", .scope = .debug, .capability = .safe },
    .{ .id = "debug.watch_refresh", .title = "Refresh Debug Watches", .description = "Evaluate safe watches in the selected paused stack frame.", .default_key = "", .scope = .debug, .capability = .safe },
